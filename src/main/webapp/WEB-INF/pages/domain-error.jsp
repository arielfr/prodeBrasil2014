<html>
	...
	<body id="prode-container">
		...
		<div id="central-container">
			...
			<div class="oe-header">
				<span class="blue">2014 FIFA World Cup Brazil</span> <span class="green subtitle">Error</span>
			</div>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<p>This application required to use an <strong>@mercadolibre</strong> account to access. Please log in with an <strong>@mercadolibre</strong> Google Account before entering again.</p>
