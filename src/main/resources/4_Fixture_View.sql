...
select ma.id as id, ma.date_match as date_match, c.name as city_name, g.name as group_name, t.name as team_a, t.flag as flag_a, te.name as team_b, te.flag as flag_b from matches ma
